...
var WebSocketService = (function () {
    ...
    WebSocketService.prototype.getBoards = function () {
        return this.listenOnChannel('boards');
    };
    WebSocketService.prototype.sendGame = function (game) {
        this.socket.emit('game', game);
    };
    WebSocketService.prototype.getTheir = function () {
